...
class QuestionsContainerItem extends StatelessWidget {

  final String text;
  final void Function() onTap;
  final bool isPressed;
  final String answerText;
  const QuestionsContainerItem({
        ...
        child: Column(
          children: [
            Row(
              children: [
                SizedBox(width: 10,),
                Text(text,style: AppTextStyles.font16.copyWith(),),
                Spacer(),
            ...
            isPressed? Container(
              ...
              child: Padding(
                ...
                child: Text(answerText,style: AppTextStyles.font16.copyWith(fontWeight: FontWeight.normal,color: AppColors.black),),
              ),
            ): SizedBox(width: 5,),
